...
//Metodo constructor de la clase autor
    public Autor(String nombre, String nacionalidad, int edad, int numLibros, int cod_autor){
        this.nombre = nombre;
...
//Equals y toString de la clase autor
    @Override
    public boolean equals(Object obj) {
        if (this == obj) return true;
        if (obj == null || getClass() != obj.getClass()) return false;
        Autor autores = (Autor) obj;
    ...
    //Otros metodos de la clase autor
